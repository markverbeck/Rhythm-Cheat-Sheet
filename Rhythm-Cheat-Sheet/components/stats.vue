<template>
  <section>
        <p class="button is-primary is-medium"
            @click="player">
            Stats
        </p>
            ...
            <div class="modalDiv">
                ...
                <ul>
                    <li v-for="(playerScore, index) in Player.scores" :key="index" >
                        <h2>{{playerScore.name}}: </h2> <p>{{playerScore.score}}%</p>
                        <h3 style="color: #cd7f32;" v-if="playerScore.score >= 70 && playerScore.score < 80">&#9733;</h3>
                        <h3 style="color: #C0C0C0;" v-if="playerScore.score >= 80 && playerScore.score < 90">&#9733;</h3>
                        <h3 style="color: #D4AF37;" v-if="playerScore.score >= 90 && playerScore.score <= 100">&#9733;</h3>
                    </li>
                </ul>
            </div>
        </b-modal>
